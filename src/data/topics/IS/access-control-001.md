...
# 정의
접근통제(Access Control)는 정보 자원(파일, 데이터베이스, 시스템 등)에 대해 인가된 사용자만이 접근하고 특정 작업을 수행할 수 있도록 제한하는 보안 메커니즘입니다. 사용자 신원 확인(인증) 후 접근 권한을 부여하며, 정보보호의 기밀성, 무결성, 가용성 보장에 핵심적인 역할을 메커니즘.
