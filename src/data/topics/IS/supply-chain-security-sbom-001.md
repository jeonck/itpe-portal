...
# 정의
공급망 보안은 소프트웨어 개발 및 배포 과정 전반에 걸쳐 발생하는 보안 위협으로부터 시스템을 보호하는 것을 목표로 합니다. 특히, SBOM(Software Bill of Materials)은 소프트웨어를 구성하는 모든 구성 요소(오픈소스, 상용 라이브러리, 의존성 등)의 목록을 제공하여 소프트웨어 공급망의 투명성을 확보하고 잠재적 취약점을 관리하는 데 필수적인 도구 기술.
