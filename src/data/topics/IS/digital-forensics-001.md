...
# 정의
디지털 포렌식(Digital Forensics)은 사이버 범죄나 보안 침해 사고 발생 시, 디지털 기기 및 저장 매체(컴퓨터, 스마트폰, 서버 등)에 남아있는 전자적 증거를 과학적이고 법률적인 절차와 방법론에 따라 수집, 분석, 보존하여 법정에서 효력을 갖도록 하는 기술 및 절차를 의미합니다. 이는 침해 사고의 원인 규명, 범인 추적, 피해 규모 산정 등에 활용 기술.
