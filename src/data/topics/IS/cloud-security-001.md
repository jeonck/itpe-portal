...
# 정의
클라우드 보안은 클라우드 환경에서 데이터, 애플리케이션, 인프라를 안전하게 보호하는 일련의 기술, 정책, 절차를 의미합니다. 클라우드 컴퓨팅의 특성상 전통적인 온프레미스 환경과는 다른 보안 위협과 도전 과제가 존재하며, CASB, CSPM, CWPP와 같은 전문화된 솔루션들이 클라우드 환경의 복잡한 보안 요구사항을 충족시키기 위해 활용.
