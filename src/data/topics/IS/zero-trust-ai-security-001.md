...
# 정의
제로 트러스트(Zero Trust)는 '절대 신뢰하지 않고 항상 검증한다'는 보안 원칙을 기반으로, 모든 사용자, 장치, 애플리케이션에 대해 지속적인 인증과 권한 부여를 요구합니다. AI 보안은 이러한 제로 트러스트 환경에서 AI 기술을 활용하여 위협 탐지, 예측, 대응을 자동화하고 보안 시스템의 지능화를 추구하는 분야입니다. 특히, AI가 발전함에 따라 AI 자체의 악용(Adversarial Attack, Poisoning) 방지도 중요해지고 있습니다 기술.
