...
# 정의
차분 프라이버시(Differential Privacy)는 데이터 분석 과정에서 개인의 민감 정보가 노출될 위험을 수학적으로 보장하며 최소화하는 기술입니다. 특정 개인의 데이터 유무와 관계없이 통계 분석 결과가 거의 동일하게 나오도록 설계되어, 데이터 집합 내의 개별 정보를 보호하면서도 유용한 통계 정보를 얻을 수 있게 기술.
