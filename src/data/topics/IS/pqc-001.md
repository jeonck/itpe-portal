...
# 정의
양자 내성 암호(PQC, Post-Quantum Cryptography)는 고성능 양자 컴퓨터의 공격에도 안전하게 설계된 암호 알고리즘을 말합니다. 현재 사용되는 대부분의 공개키 암호 시스템(RSA, ECC 등)은 쇼어(Shor) 알고리즘과 같은 양자 알고리즘에 의해 쉽게 해독될 수 있어, 양자 컴퓨팅 시대에 대비하기 위한 필수적인 보안 기술.
