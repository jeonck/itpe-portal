...
# 정의
HPC(High Performance Computing, 고성능 컴퓨팅)는 매우 복잡한 계산 문제나 대규모 데이터 처리가 요구되는 과학, 공학, 비즈니스 분야에서 최고 수준의 컴퓨팅 성능을 제공하는 시스템. 수많은 프로세서가 병렬로 연결되어 초고속 연산을 수행하며, 슈퍼컴퓨터가 HPC 시스템의 대표적인 예.
