...
# 정의
형상 관리(Configuration Management)는 소프트웨어 및 시스템의 전체 생명주기 동안 생성되는 산출물(코드, 문서, 설계도 등)의 변경 사항을 체계적으로 식별, 통제, 기록 및 감사하여 일관성과 무결성을 유지하는 활동입니다. SCM(Software Configuration Management)은 소프트웨어 개발에 특화된 형상 관리를 의미 기술.
