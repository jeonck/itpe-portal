...
# 정의
단기 목표 달성을 위해 최적이 아닌 설계나 구현을 선택함으로써 미래에 추가 비용이 발생하는 현상으로, Ward Cunningham이 제안한 개념.
...
# 정의
단기 목표 달성을 위해 최적이 아닌 설계나 구현을 선택함으로써 미래에 추가 비용이 발생하는 현상으로, Ward Cunningham이 제안한 개념입니다.
