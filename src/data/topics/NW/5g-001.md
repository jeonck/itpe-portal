...
# 정의
초고속, 초저지연, 초연결을 목표로 하는 5세대 이동통신으로, eMBB, URLLC, mMTC 3대 서비스로 구성됩니다 기술.
...
## 기술요소
5G 네트워크는 다음과 같은 아키텍처로 구성됩니다:

1. 무선 액세스 네트워크 (RAN: Radio Access Network)
